...
dotnet publish -v q product/roundhouse.console -t:Publish -p:TargetFramework=netcoreapp2.1 `
    -r win10-x64 -p:DropFolder=$CODEDROP -p:Version="$($gitVersion.FullSemVer)" -p:Configuration=Build -p:Platform="Any CPU"
