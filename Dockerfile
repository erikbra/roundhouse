...
RUN dotnet publish -v q -nologo --no-restore product/roundhouse.console -o /app/out -p:TargetFramework=net5.0 -p:Version="${VERSION}" -p:Configuration=Build -p:Platform="Any CPU"
