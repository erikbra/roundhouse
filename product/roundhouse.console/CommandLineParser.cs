...
namespace roundhouse.console
{
    public class CommandLineParser
    {
        ...
        internal ConfigurationPropertyHolder parse_arguments_and_set_up_configuration(Program.Mode mode)
        {
            bool help = false;
            ...
            OptionSet option_set = new OptionSet()
                    ...
                    .Add("f=|files=|sqlfilesdirectory=",
                        string.Format(
                            "SqlFilesDirectory - The directory where your SQL scripts are. Defaults to \"{0}\".",
                    ...
                    .Add("vf=|versionfile=",
                        string.Format(
                            "VersionFile - Either a .XML file, a .DLL or a .TXT or a .json file that a version can be resolved from. Defaults to \"{0}\".",
                            ApplicationParameters.default_version_file),
                        option => configuration.VersionFile = option)
                    .Add("vx=|versionxpath=",
                        string.Format(
                            "VersionXPath - Works in conjunction with an XML version file. Defaults to \"{0}\".",
                    ...
                    .Add("vw=|views=|viewsfolder=|viewsfoldername=",
                        string.Format(
                            "ViewsFolderName - The name of the folder where you keep your views. Will recurse through subfolders. Defaults to \"{0}\".",
            ...
            if (string.IsNullOrEmpty(configuration.DatabaseName) &&
                string.IsNullOrEmpty(configuration.ConnectionString) && mode == Program.Mode.Normal)
            {
                show_help(
