...
namespace roundhouse.console
{
    public class CommandLineParser
    {
        ...
        public ConfigurationPropertyHolder set_up_configuration_and_build_the_container(string[] args, Program.Mode mode = Program.Mode.Normal)
        {
        ...
        private void parse_arguments_and_set_up_configuration(ConfigurationPropertyHolder configuration, string[] args, Program.Mode mode)
        {
            ...
            if (string.IsNullOrEmpty(configuration.DatabaseName) && string.IsNullOrEmpty(configuration.ConnectionString) && mode == Program.Mode.Normal)
            {
